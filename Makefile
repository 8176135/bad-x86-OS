C_SOURCES = $(wildcard kernel/*.c drivers/*.c cpu/*.c util/*.c libc/*.c applications/counter/*.c)
HEADERS = $(wildcard kernel/*.h drivers/*.h cpu/*.h util/*.h libc/*.h applications/counter/*.h)
