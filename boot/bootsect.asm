...
load_kernel:
    ...
    call print_nl
    mov ax, 0x1000
    mov es, ax ; Read from disk and store in 0x10000, becasue es is bit shifted by 4 <<
    mov bx, 0x0000
    mov dh, 0x80 ; 0x80 * 512 = 0x10000. 64KB limit on kernel size lol. If we want more we have to read more times.
    mov dl, [BOOT_DRIVE]
    call disk_load
    ret
